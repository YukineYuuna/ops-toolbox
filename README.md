...
桌面端主界面：工具分类、系统概览和常用操作集中在一个工作台中。

![桌面端主界面](docs/images/dashboard.png)

> **此处演示 Windows 端使用场景**：用户可以从系统概览查看当前状态，在左侧按类别查找网络、系统、清理和性能工具，也可以直接打开右上角 AI 助手描述遇到的问题。

AI 助手面板：用日常语言描述问题，获得对应工具和排查建议。

![AI 助手面板](docs/images/ai-assistant.png)
...
壁纸功能调用[樱道 API](https://img.r10086.com/)，感谢其提供随机动漫壁纸服务。图片版权归原作者及相关服务方所有。
